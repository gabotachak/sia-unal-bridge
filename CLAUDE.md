...
es `conexiones(api) + conexiones(refresher) ≤ 80` (óptimo medido, `docs/OPEN-QUESTIONS.md`
...
**sobre la operación lógica** (§28). **80 es el óptimo medido**: contra producción
(2026-08-19) el SIA corre 80 en paralelo sin errores ni throttling y con latencia p50
plana, y en 88 ya aparece ~4.5% de fallas (`docs/OPEN-QUESTIONS.md` §5). El pool por
defecto se queda en 4 porque el tráfico real no pide más; subirlo hasta 80 menos lo que
use el `Refresher` es configuración, no rediseño.
